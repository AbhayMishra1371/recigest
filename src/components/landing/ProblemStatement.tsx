      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid  grid-cols-1 md:grid-cols-3 gap-8">
          {problems.map((problem, idx) => (
            <div 
              key={idx} 
              className="bg-[#AFCEB9] p-8 rounded-[2rem] shadow-sm border border-gray-100 transition-all hover:shadow-md group"
            >
              <div className="w-12 h-12 bg-[#E9C8CD] text-[#AA4D4D] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
